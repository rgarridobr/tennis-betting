  ...
  return (
    <Card className="max-w-2xl mx-auto rounded-3xl shadow-lg border-0">
      <CardHeader className="space-y-1 p-8">
        <CardTitle className="text-2xl font-black text-slate-800">Criar Novo Bolão</CardTitle>
        <CardDescription>
      ...
      <CardContent className="p-8 pt-0">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="pt-4 flex gap-3">
            ...
            <Button
              type="submit"
              className="flex-[2] h-12 bg-[#6EC46C] hover:bg-[#6EC46C]/90 text-white rounded-xl font-bold"
              disabled={isLoading}
            >

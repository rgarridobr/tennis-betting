...
export function TournamentCard({ tournament }: TournamentCardProps) {
  ...
  return (
    <Link href={`/torneio/${tournament.id}`}>
      <Card className="overflow-hidden hover:shadow-lg transition-shadow cursor-pointer h-full border-0 shadow-md">
        <div className="relative h-36">
          ...
          <Badge className={`absolute top-3 right-3 ${statusColor} font-medium`}>
            {statusLabel}
          </Badge>

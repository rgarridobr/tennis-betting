...
import { getGlobalRanking, getActiveTournament, getTennisClubs } from '@/lib/data';
...
export default async function PerfilPage() {
  ...
  const [ranking, activeTournament, clubs] = await Promise.all([
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                ...
                <Badge variant="secondary">
                  ...
                  {t('accountAge', { days: accountAge })}
                </Badge>
              </div>
            </div>

            <div className="text-right">
              <p className="text-sm text-slate-500">{t('rankingPosition')}</p>

...
export default async function AdminTournamentsPage() {
  ...
  return (
    <>
      <PageHero title="Gerenciar Torneios" subtitle="Crie e gerencie os Grand Slams do bolao">
                ...
                <section key={group.title}>
                  ...
                  <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {group.list.map((tournament) => (
                      ...
                      >
                        <div
                          className={`h-2 ${tournament.status === 'active' ? 'bg-emerald-500' : tournament.status === 'upcoming' ? 'bg-amber-400' : 'bg-slate-300'}`}
                        />

        ...
        {ranking.length === 0 ? (
          <Card className="border-0 shadow-md">
            <CardContent className="py-16 text-center">
              ...
              <p className="text-slate-600">Seja o primeiro a participar de um torneio!</p>
            </CardContent>
          </Card>
        ) : (
          <div className="space-y-8">
            ...
            <Card className="border-0 shadow-md overflow-hidden pt-0">
              <div className="bg-slate-100 px-6 py-4 border-b">
                <h2 className="font-semibold text-slate-900 flex items-center gap-2">Classificação Completa</h2>
              </div>
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <p className={`font-medium ${isCurrentUser ? 'text-emerald-700' : 'text-slate-900'}`}>
                              {entry.user_name}
                              {isCurrentUser && (
                                <Badge className="ml-2 bg-emerald-100 text-emerald-700 text-xs">Você</Badge>
                              )}
                            </p>
  ...
  return (
    <Card className={`border-0 shadow-lg overflow-hidden ${height} ${isCurrentUser ? 'ring-2 ring-emerald-500' : ''}`}>
      ...
      <CardContent className="p-6 text-center">
        ...
        <Badge className={`mb-3 bg-gradient-to-r ${gradient} text-white border-0`}>{label}</Badge>
